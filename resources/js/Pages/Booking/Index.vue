...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            ...
            <Link
                class="focus:outline-none text-white bg-green-400 hover:bg-green-500 focus:ring-2 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:focus:ring-green-900"
